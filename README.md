...
```
cd existing_repo
git remote add origin https://gitlab.uni-marburg.de/dausend4/myawesometest.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.uni-marburg.de/dausend4/myawesometest/-/settings/integrations)
