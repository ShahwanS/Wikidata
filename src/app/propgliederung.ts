...
export const propgliederung: Category[] = [
    { 
        ...
        description: "Größe des Gebäudes und Angaben zu Räumen Stockwerken, Fahrstühlen",
        subcategories: [
            { 
                name: "Dimensionen", 
            ...
            { 
                ...
                properties: [
                    { name: "Oberirdische Stockwerke", type: "number", wikidataprop: "P1101"},
                    { name: "Unterirdische Stockwerke", type: "number", wikidataprop: "P1139" },
                    { name: "Anzahl an Fahrstühlen", type: "number", wikidataprop: "P1301" }, // nur wenn es mehrere Stockwerke gibt
                ]
            },
            {
                ...
                properties: [
                    ...
                    { name: "ist Teil von", type: "text", description: "z.B. größerer Gebäudekomplex", wikidataprop: "P361"},
                    { name: "enthält" , type: "text", description: "z.B. einzelne bedeutende Räume", wikidataprop: "P527"}
                ]
            },
            {
                name: "Zugänglichkeit",
                ...
                properties: [
                    { name: "Rollstuhl geeignet", type: "checkbox", wikidataprop: "P2846"}
                ]
            }
        ]
    },
    ...
    {
        title: "Baudetails",
        description: "Angaben zu Material, Baumethode, Bauunternehmen, Kosten u.a. ",
        subcategories: [
            {
                name: "",
                description: "",
                properties: [
                    ...
                    { name: "Baukosten", type: "number", description: "in EUR", wikidataprop: "P2130"},
                ]
            }
        ]
    },
        ...
        subcategories: [
            {
                ...
                properties: [
                    ...
                    { name: "physisch verbunden mit", type: "text", wikidataprop: "P2789"},
                    { name: "Koordinaten", type: "text", wikidataprop: "P625"},
                    { name: "Zeitzone", type: "text", fixed: true, wikidataprop: "P6237"}, //immer MEZ
        ...
        subcategories: [
            {
                ...
                properties: [
                    ...
                    { name: "Konfessionszugehörigkeit", type: "text", wikidataprop: "P140"},
                ]
            },
        ]
    },
        ...
        subcategories: [
            {
                ...
                description: "",
                properties: [
                    { name: "ist Instanz von", fixed: true, type: "text", wikidataprop: "P31"}, // immer Gebäude
                    { name: "Commons-Kategorie", type: "text", wikidataprop: "P373"},
                    { name: "Schutzkategorie", type: "text", wikidataprop: "P1435"},
                    { name: "steht in der Denkmalliste", type: "text", wikidataprop: "P2817"}, // > Liste müsste erstellt werden
                ]
            },
        ]
    },
