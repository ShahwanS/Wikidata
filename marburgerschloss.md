...
total number of below ground floors of the building
### P1101	floors above ground	
above ground floor count of a building (ground floor and attic included)
### P941	inspired by	
work, human, place or event which inspired this creative work or fictional entity
### P2046	area	
area occupied by an object
### P2048	height	
vertical length of an entity
### P2846	wheelchair accessibility	
describes wheelchair accessibility of location or event
### P186	made from material	
material the subject or the object is made of or derived from
...
name of the Wikimedia Commons category containing files related to this item	Wikimedia? // Andere Identifiers?
### P31	instance of	
that class of which this subject is a particular example and member,	Subclasses möglich
Gebäude, Schloss?
### P2817	appears in the heritage 
monument list	heritage monument is a part of the list of heritage monuments	
### P361	part of	
object of which the subject is a part	Auch Umkehr möglich (P527)
### P1435	heritage designation	
heritage designation of a cultural or natural site	

## Geographisch
### P3032	adjacent building	
building adjacent to the item	
Hexenturm
### P669	located on street	
street, road, or square," where the item is located.	To add the number"," use Property:P670 """"house number"""" as qualifier.""
Schloss
### P276	location	 
location of the object, structure or event.	 In the case of an administrative entity as containing item use P131. 
Marburg
...
to indicate state of conservation of a building, monument, etc.	
### P366	has use	
main use of the subject (includes current and former usage)	
Museum, Stiftung, Studentenwohnheim
### P793	significant event	
significant or notable events associated with the subject	
### P1813	short name	
short name of a place, organisation, person, journal, wikidata property, etc.	
### P1448	official name	
